    ...
    return (
        <SiteLayout title="Office of the Senior Citizen's Affairs - Privacy Policy" setLoading={setLoading}>
            ...
            <div className="flex flex-col justify-center items-left p-10">
                ...
                <p className="text-base"><b>Suggested text:</b> Our website address is: https://oscaweb.altustechcorpdev.com.</p>
                <h1 className="font-bold text-4xl">Comments</h1>
                <p className="text-base"><b>Suggested text:</b> When visitors leave comments on the site we collect the data shown in the comments form, and also the visitor’s IP address and browser user agent string to help spam detection.</p>
                ...
                <p className="text-base"><b>Suggested text:</b> If you upload images to the website, you should avoid uploading images with embedded location data (EXIF GPS) included. Visitors to the website can download and extract any location data from images on the website.</p>
                <h1 className="font-bold text-4xl">Cookies</h1>
                <p className="text-base"><b>Suggested text:</b> If you leave a comment on our site you may opt-in to saving your name, email address and website in cookies. These are for your convenience so that you do not have to fill in your details again when you leave another comment. These cookies will last for one year.</p>
                ...
                <p className="text-base"><b>Suggested text:</b> Articles on this site may include embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.</p>
                ...
                <p className="text-base"><b>Suggested text:</b> If you request a password reset, your IP address will be included in the reset email.</p>
                <h1 className="font-bold text-4xl">How long we retain your data</h1>
                <p className="text-base"><b>Suggested text:</b> If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognize and approve any follow-up comments automatically instead of holding them in a moderation queue.</p>
                ...
                <p className="text-base"><b>Suggested text:</b> If you have an account on this site, or have left comments, you can request to receive an exported file of the personal data we hold about you, including any data you have provided to us. You can also request that we erase any personal data we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.</p>
                <h1 className="font-bold text-4xl">Where we send your data</h1>
                <p className="text-base"><b>Suggested text:</b> Visitor comments may be checked through an automated spam detection service.</p>
                <Divider />
            </div>
        </SiteLayout>
    );
